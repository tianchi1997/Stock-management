...
RSpec.describe StockItemsController, type: :controller do
  ...
  describe "GET #edit" do
    it "returns a success response" do
      stock_item = StockItem.create! valid_attributes
      get :edit, params: {id: stock_item.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the stock_item" do
        stock_item = StockItem.create! valid_attributes
        put :update, params: {id: stock_item.to_param, stock_item: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        stock_item = StockItem.create! valid_attributes
        put :update, params: {id: stock_item.to_param, stock_item: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested stock_item" do
      stock_item = StockItem.create! valid_attributes
      expect {
        delete :destroy, params: {id: stock_item.to_param}, session: valid_session
      }.to change(StockItem, :count).by(-1)
    end
